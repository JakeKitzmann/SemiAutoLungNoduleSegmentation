...
class LungNoduleSegmentationWidget(ScriptedLoadableModuleWidget, VTKObservationMixin):
    ...
    def setup(self):
        ...
        self.ui.segmentEditor.setMRMLScene(slicer.mrmlScene)
        self.ui.segmentEditor.setSegmentationNode(self.ui.segmentationComboBox.currentNode())
        self.ui.segmentEditor.setMasterVolumeNode(self.ui.volumeComboBox.currentNode())
...
class DeepLearningSegmentation:
    ...
    def run(self, inputVolume):
        ...
        model = UNet3D()
        model.load_state_dict(torch.load('/Users/jacob_kitz/Desktop/LungNoduleSegmentation/LungNoduleSegmentation/LungNoduleSegmentation/NetworkStructure/nov9_24.pth', map_location=torch.device('cpu')))
        # print(model.eval())
